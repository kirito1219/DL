...
def parse_args():
    ...
    # config
    parser.add_argument('-d', '--data-path', default='/home/mbl/Hsin/cincgan/DIV2K/lr_image/', type=str)
    parser.add_argument('-g', '--gpu', default=0, type=int)
    parser.add_argument('-w1', '--weights-dir', default='output-0/', type=str)
    parser.add_argument('-w2', '--output-dir', default='test_output/', type=str)
