...
def parse_args():
    ...
    # config
    parser.add_argument('-hr', '--hr-path', default="/home/mbl/Hsin/cincgan/DIV2K/hr_image/", type=str)
    parser.add_argument('-lr', '--lr-path', default="/home/mbl/Hsin/cincgan/DIV2K/lr_image/", type=str)
    parser.add_argument('-t', '--target-dir', default="/home/mbl/Hsin/cincgan/DIV2K/dataset/", type=str)
...
def crop(args):
    ...
    # open image
    assert len(os.listdir(args.lr_path)) == len(os.listdir(args.hr_path))
