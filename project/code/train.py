...
from loss import generator_discriminator_loss, discriminator_loss, cycle_loss, cycle_loss_sr, identity_loss, identity_loss_sr, tvloss, tvloss_sr
...
def parse_args():
    ...
    # config
    parser.add_argument('-d', '--data-path', default="/home/mbl/Hsin/cincgan/DIV2K/dataset/", type=str)
    parser.add_argument('-g', '--gpu', default=0, type=int)
    parser.add_argument('-l', '--log-dir', default='output-1/', type=str)
    # Train Setting
...
def main(args):
    ...
    for epoch in range(args.epochs):
        ...
        for _, batch in enumerate(trainloader):
            ...
            lr_loss = loss_G1 + loss_cycle + loss_idt + loss_tv
            lr_loss.backward()
            ...
            if iter_index % 1000 == 0:
                print('iter {}: LR: loss_D1={}, loss_GD={}, loss_cycle={}, loss_idt={}, loss_tv={}, lr_loss={}'.format(iter_index, loss_D1.item(),
                                                                                                           loss_G1.item(),
                                                                                                           loss_cycle.item(),
                                                                                                           loss_idt.item(),
                                                                                                           loss_tv.item(),
                ...
                writer.add_scalar('LR/loss_D1', loss_D1.item(), iter_index // 1000)
                writer.add_scalar('LR/loss_GD', loss_G1.item(), iter_index // 1000)
                writer.add_scalar('LR/loss_cycle', loss_cycle.item(), iter_index // 1000)
                writer.add_scalar('LR/loss_idt', loss_idt.item(), iter_index // 1000)
                writer.add_scalar('LR/loss_tv', loss_tv.item(), iter_index // 1000)
                writer.add_image('LR/origin', image[0], iter_index // 1000)
                writer.add_image('LR/denoise', G_1(image)[0], iter_index // 1000)
            ...
            # GD loss for SR
            image_temp = G_1(image_clean)
            loss_SR = generator_discriminator_loss(generator=SR, discriminator=D_2, input=image_temp)
            #loss_SR.backward()

            # cycle loss for SR and G_3
            loss_cycle = 10 * cycle_loss_sr(G_1, G_3, SR, image_clean)
            #loss_cycle.backward()
            ...
            # tvloss for SR
            loss_tv = 2 * tvloss_sr(input=image_clean, generator=G_1, sr=SR)
            #loss_tv.backward()

            sr_loss = loss_SR + loss_cycle + loss_idt + loss_tv
            sr_loss.backward()
            ...
            if iter_index % 1000 == 0:
                print('         SR: loss_D2={}, loss_SR={}, loss_cycle={}, loss_idt={}, loss_tv={}, sr_loss={}'.format(loss_D2.item(),
                                                                                                                 loss_SR.item(),
                                                                                                                 loss_cycle.item(),
                                                                                                                 loss_idt.item(),
                                                                                                                 loss_tv.item(),
                ...
                writer.add_scalar('SR/loss_D2', loss_D2.item(), iter_index // 1000)
                writer.add_scalar('SR/loss_SR', loss_SR.item(), iter_index // 1000)
                writer.add_scalar('SR/loss_cycle', loss_cycle.item(), iter_index // 1000)
                writer.add_scalar('SR/loss_idt', loss_idt.item(), iter_index // 1000)
                writer.add_scalar('SR/loss_tv', loss_tv.item(), iter_index // 1000)
                writer.add_image('SR/origin', image[0], iter_index // 1000)
                writer.add_image('SR/clean_image', G_1(image)[0], iter_index // 1000)
                writer.add_image('SR/SR', SR(G_1(image))[0], iter_index // 1000)
                writer.flush()
                print('\n')
        ...
        G_1.eval()
        SR.eval()
        image = Image.open('/home/mbl/Hsin/cincgan/DIV2K/lr_image/0001x4d.png')
